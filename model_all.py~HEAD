...
class Pose_GAN(Network):
	def __init__(self, traing1ornot):
		...
		self.traing2ornot = traing2ornot
		self.N = cfg.N
	...
	def __setup(self):
		...
		print('G1 encoder')
		(self.feed('g1_input')
			 .conv2d(3, 128, 1, 1, name = 'conv', trainable = self.traing2ornot)
			 .conv2d(3, 128, 1, 1, name = 'block1_conv1', trainable = self.traing2ornot)
			 .conv2d(3, 128, 1, 1, name = 'block1_conv2', trainable = self.traing2ornot))
		(self.feed('conv', 'block1_conv2')
			 .add(name = 'add_1')
			 .conv2d(3, 256, 2, 2, name = 'down_sample1', relu = False, trainable = self.traing2ornot)
			 .conv2d(3, 256, 1, 1, name = 'block2_conv1', trainable = self.traing2ornot)
			 .conv2d(3, 256, 1, 1, name = 'block2_conv2', trainable = self.traing2ornot))
		(self.feed('down_sample1', 'block2_conv2')
			 .add(name = 'add_2')
			 .conv2d(3, 384, 2, 2, name = 'down_sample2', relu = False, trainable = self.traing2ornot)
			 .conv2d(3, 384, 1, 1, name = 'block3_conv1', trainable = self.traing2ornot)
			 .conv2d(3, 384, 1, 1, name = 'block3_conv2', trainable = self.traing2ornot))
		(self.feed('down_sample2', 'block3_conv2')
			 .add(name = 'add_3')
			 .conv2d(3, 512, 2, 2, name = 'down_sample3', relu = False, trainable = self.traing2ornot)
			 .conv2d(3, 512, 1, 1, name = 'block4_conv1', trainable = self.traing2ornot)
			 .conv2d(3, 512, 1, 1, name = 'block4_conv2', trainable = self.traing2ornot))
		(self.feed('down_sample3', 'block4_conv2')
			 .add(name = 'add_4')
			 .conv2d(3, 640, 2, 2, name = 'down_sample4', relu = False, trainable = self.traing2ornot)
			 .conv2d(3, 640, 1, 1, name = 'block5_conv1', trainable = self.traing2ornot)
			 .conv2d(3, 640, 1, 1, name = 'block5_conv2', trainable = self.traing2ornot))
		(self.feed('down_sample4', 'block5_conv2')
			 .add(name = 'add_5')
			 .conv2d(3, 768, 2, 2, name = 'down_sample5', relu = False, trainable = self.traing2ornot)
			 .conv2d(3, 768, 1, 1, name = 'block6_conv1', trainable = self.traing2ornot)
			 .conv2d(3, 768, 1, 1, name = 'block6_conv2', trainable = self.traing2ornot))
		(self.feed('down_sample5', 'block6_conv2')
			 .add(name = 'add_6')
			 .fc(64, name = 'fc_1', relu = False, trainable = self.traing2ornot))
		...
		#=============G1 decoder============
		print('=============G1 decoder=============')
		(self.feed('fc_1').fc(W * H * 768, name = 'fc2', relu = False, trainable = self.traing2ornot)
			 .reshape(cfg.BATCH_SIZE, W, H, 768, name = 'reshape'))
		(self.feed('reshape', 'block6_conv2')
			 .add(name = 'skip_add_1')
			 .conv2d_tran(3, 768, 1, 1, name = 'block1_dconv1', trainable = self.traing2ornot)
			 .conv2d_tran(3, 768, 1, 1, name = 'block1_dconv2', trainable = self.traing2ornot))
		(self.feed('skip_add_1', 'block1_dconv2')
			 .add(name = 'back_add_1')
			 .conv2d_tran(3, 640, 2, 2, name = 'up_sample1', relu = False, trainable = self.traing2ornot))
		(self.feed('up_sample1', 'block5_conv2')
			 .add(name = 'skip_add_2')
			 .conv2d_tran(3, 640, 1, 1, name = 'block2_dconv1', trainable = self.traing2ornot)
			 .conv2d_tran(3, 640, 1, 1, name = 'block2_dconv2', trainable = self.traing2ornot))
		(self.feed('skip_add_2', 'block2_dconv2')
			 .add(name = 'back_add_2')
			 .conv2d_tran(3, 512, 2, 2, name = 'up_sample2', relu = False, trainable = self.traing2ornot))
		(self.feed('up_sample2', 'block4_conv2')
			 .add(name = 'skip_add_3')
			 .conv2d_tran(3, 512, 1, 1, name = 'block3_dconv1', trainable = self.traing2ornot)
			 .conv2d_tran(3, 512, 1, 1, name = 'block3_dconv2', trainable = self.traing2ornot))
		(self.feed('skip_add_3', 'block3_dconv2')
			 .add(name = 'back_add_3')
			 .conv2d_tran(3, 384, 2, 2, name = 'up_sample3', relu = False, trainable = self.traing2ornot))
		(self.feed('up_sample3', 'block3_conv2')
			 .add(name = 'skip_add_4')
			 .conv2d_tran(3, 384, 1, 1, name = 'block4_dconv1', trainable = self.traing2ornot)
			 .conv2d_tran(3, 384, 1, 1, name = 'block4_dconv2', trainable = self.traing2ornot))
		(self.feed('skip_add_4', 'block4_dconv2')
			 .add(name = 'back_add_4')
			 .conv2d_tran(3, 256, 2, 2, name = 'up_sample4', relu = False, trainable = self.traing2ornot))
		(self.feed('up_sample4', 'block2_conv2')
			 .add(name = 'skip_add_5')
			 .conv2d_tran(3, 256, 1, 1, name = 'block5_dconv1', trainable = self.traing2ornot)
			 .conv2d_tran(3, 256, 1, 1, name = 'block5_dconv2', trainable = self.traing2ornot))
		(self.feed('skip_add_5', 'block5_dconv2')
			 .add(name = 'back_add_5')
			 .conv2d_tran(3, 128, 2, 2, name = 'up_sample5', relu = False, trainable = self.traing2ornot))
		(self.feed('up_sample5', 'block1_conv2')
			 .add(name = 'skip_add_6')
			 .conv2d_tran(3, 128, 1, 1, name = 'block6_dconv1', trainable = self.traing2ornot)
			 .conv2d_tran(3, 128, 1, 1, name = 'block6_dconv2', trainable = self.traing2ornot))
		(self.feed('up_sample5', 'block1_conv2')
			 .add(name = 'back_add_6')
			 .conv2d_tran(3, 3, 1, 1, name = 'g1_result', trainable = self.traing2ornot))
